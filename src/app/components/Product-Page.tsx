...
export default function ProductPage() {
  ...
  const handleAddToCart = async () => {
    ...
    addToCart({
      ...
      weight: 500, // You can make this dynamic if needed
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex space-x-2 overflow-x-auto">
            {selectedProduct.thumbnails.map((thumbnail, i) => (
              <button
                ...
                onClick={() =>
                  setSelectedProduct({ ...selectedProduct, image: thumbnail })
                }
              >
                <Image
                  src={thumbnail}
        ...
        <div className="md:col-span-1">
          <div className="flex items-center mb-2">
            <h2 className="text-2xl font-medium text-gray-900 mr-2">
              Fresh Basket
            </h2>
          ...
          <p className="text-gray-500 mb-6 font-light text-base">
          ...
          <div className="flex items-center space-x-4 mb-6 font-medium text-sm">
            <button className="px-4 py-2 border rounded-md hover:bg-gray-50 cursor-pointer">
              250 G
            </button>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center border rounded-md">
                <button className="px-3 py-1 text-gray-500 cursor-pointer">
                  −
                </button>
                <input
                  type="number"
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="flex items-center">
              <span className="text-gray-700 w-24 font-light ">
                Shipped By:
              </span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              className="bg-green-500 hover:bg-green-600 text-white py-3 rounded-md font-medium text-xl cursor-pointer flex items-center justify-center"
