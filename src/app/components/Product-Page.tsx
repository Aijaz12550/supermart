    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex space-x-2 overflow-x-auto">
             {[1, 2, 3, 4].map((i) => (
              ...
              >
                <Image
                  src={ProductImage}
                  alt={`Red Bell Pepper thumbnail ${i}`}
                  width={60}
                  height={60}
                  className="w-full object-cover"
                />
        ...
        <div className="md:col-span-1">
          ...
          <h1 className="text-3xl font-medium text-gray-900 mb-4">Fresh Red-Bell Pepper, 500g</h1>
          <div className="text-4xl font-bold text-gray-900 mb-4">Rs 500</div>
